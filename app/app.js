...
var TodoApp = (function () {
    ...
    TodoApp.prototype.updateTodoListDate = function (itemIndex, value) {
        console.log("updateTodoListDate", itemIndex, value);
    };
    TodoApp.prototype.millisecondTest = function (value) {
        console.log("millisecondTest", value);
    };
    TodoApp = __decorate([
        core_1.Component({
            selector: 'todo-app',
